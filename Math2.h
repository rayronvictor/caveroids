...
class Math
{
        public:
                // 2D Vector math
                static Vector2 VectorLineIntersection(Vector2& point, Vector2& direction, Vector2& linepoint1, Vector2& linepoint2);
                ...
                // Primarily to be used for OpenGL 2D POT texture loading
